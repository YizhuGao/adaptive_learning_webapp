...
// Function to mark the video as watched and notify the server (complete_video)
function markVideoAsWatched(subtopicId, studentId) {
    ...
    // Construct the URL for the complete_video function dynamically
    const url = `/complete-video/${subtopicId}/${studentId}/`; // Assuming the URL pattern for your Django route

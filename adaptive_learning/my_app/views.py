...
from adaptive_learning.my_app.models import Assessment
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                return redirect('success')  # Redirect to success.html after login
            else:
...
def signup_view(request):
    if request.method == 'POST':
        ...
        return redirect('success')  # Redirect to success.html after signup
